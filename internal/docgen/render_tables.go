...
func statesTable(states []FeatureState) string {
	b := &strings.Builder{}
	b.WriteString("<table border=\"1\"><tr><th>Feature</th><th>Current Step</th><th>Status</th></tr>")
...
func evidenceTable(items []EvidenceLink) string {
	b := &strings.Builder{}
	b.WriteString("<table border=\"1\"><tr><th>Role</th><th>Feature</th><th>Step</th><th>Code refs</th></tr>")
