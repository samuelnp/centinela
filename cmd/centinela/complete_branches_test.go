...
func TestRunCompleteValidateErrorAndWarningBranches(t *testing.T) {
	...
	os.WriteFile(".workflow/f-validation-specialist.json", []byte(`{"feature":"f","step":"validate","role":"validation-specialist","status":"done","generatedAt":"2026-05-09T00:00:00Z","inputs":["i"],"outputs":[".workflow/f-validation-specialist.md"],"edgeCases":[],"handoffTo":"complete"}`), 0644) //nolint:errcheck
