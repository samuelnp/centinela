...
internal/
  ...
  docstring/          # Leaf: Go AST scanner + language seam for the docstring gate (stdlib only)
  ...
  teamdashboard/      # Aggregator: computes the multi-feature team-status board (in-flight, roadmap, gate health) from in-memory inputs (pure, read-only)
docs/
...
| Aggregator — team dashboard | `internal/teamdashboard/` |
| Infrastructure | `internal/setup/`, `internal/scaffold/` |
