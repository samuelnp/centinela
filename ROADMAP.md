...
- **package-doc-comments** — 572 of 599 non-test Go files carry no package-clause doc comment; docstring-gate v1 excludes package docs entirely — a per-package (not per-file) rule is a separate check *(deferred 2026-07-31T09:18:01Z · docstring-gate/planner)*
- **docstring-struct-field-docs** — 597 undocumented exported struct fields (73% of the non-test docstring backlog); docstring-gate v1 excludes them behind check_fields=false *(deferred 2026-07-31T09:18:01Z · docstring-gate/planner)*
- **docstring-full-scan-debt-paydown** — Document the 171 legacy exported identifiers in files the ratcheted docstring gate never opens, so centinela docs lint --full could report zero; replaces docstring-gate-ratchet-to-fail, which is moot because the gate ships enforcing at severity=fail *(deferred 2026-07-31T09:50:43Z · docstring-gate/senior-engineer)*
