...
- **nested-worktrees-resolve-outermost** — a path with repeated .worktrees segments resolves the outermost feature; harmless today because the resolved slug must now have real workflow state, but the choice is arbitrary rather than reasoned *(deferred 2026-08-03T12:40:30Z · evidence-schema-skeleton-legacy-handoff/edge-case-tester)*
