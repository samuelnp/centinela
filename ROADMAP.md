...
- **route-state-integrity-guard** — Floors are enforced only in route set; modelRoutes written directly into the agent-writable .workflow/<f>.json bypass them and downgrade the gatekeeper *(deferred 2026-07-30T18:12:16Z · dynamic-model-routing/edge-case-tester)*
