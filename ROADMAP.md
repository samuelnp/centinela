...
- **surface-line-format-detection** — IsUserFacingFeature misses 'surface:' lines in blockquote/bullet/bold form (e.g. landing-page.md '> surface: user-facing'), silently downgrading user-facing features to the internal docs contract *(deferred 2026-07-30T11:50:54Z · docs-step-markdown-first/edge-case-tester)*
...
- **legacy-docs-specs-contradiction** — Rewrite legacy spec scenarios still pinning deleted docs generate/validate + portal regen (right-size-docs-step, docs-knowledge-base-pages, generate-html-project-docs, improve-docs-llm-hybrid-ui, merge-truthful-delivery) *(deferred 2026-07-30T12:38:31Z · docs-step-markdown-first/gatekeeper)*
